...
#define MEW_RVA_MEWDIRECTOR_SINGLETON 0x013D1970ULL // This points at the process-wide MewUIDirector singleton used to walk loaded scenes...
...
#define MEW_OFF_MEWDIRECTOR_DIRECTOR 0x28U // This reaches the root scene collection from the MewUIDirector singleton...
...
typedef struct MewUIDirectorRoot
{
    MewVectorScenePtr scenes;
} MewUIDirectorRoot;

typedef struct MewUIDirector
{
    uint8_t padding_0[40];
    MewUIDirectorRoot* director;
} MewUIDirector;
...
// Returns the global MewUIDirector singleton when the game base is known...
